...
import { CreateGameSessionInput, CreateGameSessionOutput } from "../models/models_0.ts";
import {
 ...
 * ```javascript
 * import { GameLiftClient, CreateGameSessionCommand } from "../../client-gamelift/mod.ts";
