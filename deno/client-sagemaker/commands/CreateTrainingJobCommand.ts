...
import { CreateTrainingJobRequest, CreateTrainingJobResponse } from "../models/models_1.ts";
import {
 ...
 * ```javascript
 * import { SageMakerClient, CreateTrainingJobCommand } from "../../client-sagemaker/mod.ts";
