...
import { DynamoDBDocumentClient, TranslateConfig } from "./DynamoDBDocumentClient.ts";
import {
  BatchExecuteStatementCommand,
  BatchExecuteStatementCommandInput,
  BatchExecuteStatementCommandOutput,
} from "./commands/BatchExecuteStatementCommand.ts";
import { BatchGetCommand, BatchGetCommandInput, BatchGetCommandOutput } from "./commands/BatchGetCommand.ts";
import { BatchWriteCommand, BatchWriteCommandInput, BatchWriteCommandOutput } from "./commands/BatchWriteCommand.ts";
import { DeleteCommand, DeleteCommandInput, DeleteCommandOutput } from "./commands/DeleteCommand.ts";
import {
...
} from "./commands/ExecuteTransactionCommand.ts";
import { GetCommand, GetCommandInput, GetCommandOutput } from "./commands/GetCommand.ts";
import { PutCommand, PutCommandInput, PutCommandOutput } from "./commands/PutCommand.ts";
...
import { TransactGetCommand, TransactGetCommandInput, TransactGetCommandOutput } from "./commands/TransactGetCommand.ts";
import {
  TransactWriteCommand,
  TransactWriteCommandInput,
  TransactWriteCommandOutput,
} from "./commands/TransactWriteCommand.ts";
import { UpdateCommand, UpdateCommandInput, UpdateCommandOutput } from "./commands/UpdateCommand.ts";
import { DynamoDBClient } from "../client-dynamodb/mod.ts";
